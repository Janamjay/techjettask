  ...
  return (
    <div className='w-full bg-black '>
      ...
      <section className='w-full flex px-5 mt-10'>
          <div className='w-[20%]'>
            <img src={Usa} alt="" className='w-[100px] h-[100px]'/>
          </div>
          <div className='w-[30%]'>
          ...
          <div className='w-[25%]'>
            ...
            <p className='text-gray-400'>Email: <span className='text-white'>help@titan.com</span></p>
            <p className='text-gray-400'>Phone Number: <span className='text-white'>+91-989802929</span></p>
          </div>
